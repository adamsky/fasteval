use fasteval::{Cached, CachedCallbackNamespace, EmptyNamespace, Error, Evaler, Parser, Slab};
...
#[test]
fn aaa_aaa_sizes() {
    eprintln!("sizeof(Slab):{}", mem::size_of::<Slab<f64>>());
    assert!(mem::size_of::<Slab<f64>>() < 2usize.pow(18)); // 256kB
}
